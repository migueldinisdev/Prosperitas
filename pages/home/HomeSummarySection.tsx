    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6">
        <Card className="md:col-span-1">
          <p className="text-app-text-secondary text-sm font-medium mb-1">Total Net Worth</p>
          <h2 className="text-4xl font-bold text-app-text-primary tracking-tight mb-2">$124,500.00</h2>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-zinc-200 border-app-border">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <div className="p-1.5 bg-emerald-500/10 rounded-lg text-app-success">
                  <ArrowUpRight size={16} />
                </div>
                <p className="text-app-text-secondary text-xs font-medium">Unrealized PnL</p>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-app-text-secondary text-xs font-medium">Realized PnL (YTD)</p>
              </div>
