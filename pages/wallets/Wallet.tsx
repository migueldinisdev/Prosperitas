...
export const WalletDetail: React.FC<Props> = ({ onMenuClick }) => {
  ...
  return (
    <div className="pb-20">
      <div className="sticky top-0 z-30 bg-zinc-50/80 dark:bg-app-bg/80 backdrop-blur-md border-b border-zinc-200 dark:border-app-border px-6 py-4 flex items-center gap-4">
         <Link to="/wallets" className="p-2 -ml-2 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white rounded-lg hover:bg-zinc-100 dark:hover:bg-white/5 transition-colors">
            <ArrowLeft size={20} />
         </Link>
         <h1 className="text-xl font-bold text-zinc-900 dark:text-white">{walletName}</h1>
      </div>
      ...
      <main className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
           <Card className="p-4">
              <p className="text-xs text-zinc-600 dark:text-zinc-500 uppercase tracking-wider font-semibold">Current Value</p>
              <p className="text-2xl font-bold text-zinc-900 dark:text-white mt-1">$45,230.50</p>
           </Card>
           <Card className="p-4">
              <p className="text-xs text-zinc-600 dark:text-zinc-500 uppercase tracking-wider font-semibold">Invested</p>
              <p className="text-2xl font-bold text-zinc-700 dark:text-zinc-300 mt-1">$42,030.00</p>
           </Card>
           <Card className="p-4">
              <p className="text-xs text-zinc-600 dark:text-zinc-500 uppercase tracking-wider font-semibold">Total PnL</p>
           ...
           <Card className="p-4">
              <p className="text-xs text-zinc-600 dark:text-zinc-500 uppercase tracking-wider font-semibold">Cash Available</p>
              <p className="text-2xl font-bold text-zinc-900 dark:text-white mt-1">$1,200.00</p>
           </Card>
        </div>
           ...
           <Card title="Holdings" className="lg:col-span-2">
              <div className="overflow-x-auto">
                 <table className="w-full text-sm text-left">
                    <thead className="text-xs text-zinc-600 dark:text-zinc-500 uppercase border-b border-zinc-200 dark:border-app-border">
                       <tr>
