  ...
  return (
    <div className="pb-20">
      <div className="sticky top-0 z-30 bg-zinc-50/80 bg-app-bg/80 backdrop-blur-md border-b border-zinc-200 border-app-border px-6 py-4 flex items-center gap-4">
         ...
         <h1 className="text-xl font-bold text-app-text-primary">{walletName}</h1>
      </div>
      ...
      <main className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
           <Card className="p-4">
              <p className="text-xs text-app-text-secondary uppercase tracking-wider font-semibold">Current Value</p>
              <p className="text-2xl font-bold text-app-text-primary mt-1">$45,230.50</p>
           </Card>
           <Card className="p-4">
              <p className="text-xs text-app-text-secondary uppercase tracking-wider font-semibold">Invested</p>
              <p className="text-2xl font-bold text-app-text-secondary mt-1">$42,030.00</p>
           </Card>
           <Card className="p-4">
              <p className="text-xs text-app-text-secondary uppercase tracking-wider font-semibold">Total PnL</p>
           ...
           <Card className="p-4">
              <p className="text-xs text-app-text-secondary uppercase tracking-wider font-semibold">Cash Available</p>
              <p className="text-2xl font-bold text-app-text-primary mt-1">$1,200.00</p>
           </Card>
        </div>
              ...
              <div className="overflow-x-auto">
                 <table className="w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-app-border">
                       <tr className="group hover:bg-app-card/50 transition-colors">
                          <td className="px-4 py-3 font-medium text-app-text-primary">Bitcoin <span className="text-app-text-secondary ml-1">BTC</span></td>
                          <td className="px-4 py-3 text-right text-app-text-secondary">$34,200.00</td>
                          <td className="px-4 py-3 text-right text-app-text-primary font-medium">$27,000.00</td>
                          <td className="px-4 py-3 text-right text-app-success">+$2,400.00</td>
                       </tr>
                       <tr className="group hover:bg-app-card/50 transition-colors">
                          <td className="px-4 py-3 font-medium text-app-text-primary">Ethereum <span className="text-app-text-secondary ml-1">ETH</span></td>
                          <td className="px-4 py-3 text-right text-app-text-secondary">$1,850.00</td>
                          <td className="px-4 py-3 text-right text-app-text-primary font-medium">$13,500.00</td>
